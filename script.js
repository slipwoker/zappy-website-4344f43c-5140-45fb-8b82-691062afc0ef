    ...
    if (contactForm) {
        ...
        function validateField(field) {
            ...
            if (field.hasAttribute('required') && !value) {
                const label = field.closest('label')?.textContent?.trim() || name;
                showError(field, (label ? label : 'This field') + ' is required.');
                return false;
            }
            ...
            if (field.hasAttribute('maxlength') && value.length > parseInt(field.getAttribute('maxlength'))) {
                showError(field, 'Maximum ' + field.getAttribute('maxlength') + ' characters allowed.');
                return false;
            }
                ...
                fetch(action, options)
                    ...
                    .then(function() {
                        ...
                        if (!contactForm.querySelector('.form-success')) {
                            ...
                            successMsg.style.cssText = 'color: #38a169; font-size: 1rem; margin-top: 1rem;';
                    ...
                    .catch(function() {
                        const errorMsg = contactForm.querySelector('.form-error-global') || document.createElement('div');
                        if (!contactForm.querySelector('.form-error-global')) {
                            errorMsg.className = 'form-error-global';
                            errorMsg.style.cssText = 'color: #e53e3e; font-size: 1rem; margin-top: 1rem;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4344f43c-5140-45fb-8b82-691062afc0ef',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4344f43c-5140-45fb-8b82-691062afc0ef';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4344f43c-5140-45fb-8b82-691062afc0ef';
